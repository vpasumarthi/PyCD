...
class DataProfile(object):
    def __init__(self, dst_path, system_directory_path, species_count_list,
    ...
    def generate_work_dir_path(self, n_electrons, n_holes):
    ...
    def diffusion_profile(self, plot_error_bars, msd_t_final, repr_time):
        ...
        filename = (str(species_type) + '_diffusion_profile_' + self.ion_charge_type[0]
                    + self.species_charge_type[0] + '_' + str(profiling_species_list[0])
