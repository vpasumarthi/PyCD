...
def bvoMSD(systemSize, pbc, nDim, Temp, speciesCount, tFinal, nTraj, timeInterval, 
    ...
    if not os.path.exists(workDirPath):
        ...
        bvoAnalysis = analysis(bvo, nDim, systemSize, speciesCount, nTraj, tFinal, 
        ...
        bvoAnalysis.generateMSDPlot(msdData, stdData, displayErrorBars, speciesTypes, fileName, workDirPath)