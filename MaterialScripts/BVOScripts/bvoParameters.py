...
class bvoParameters(object):
    ...
    def __init__(self):
        ...
        self.neighborCutoffDist = {'V:V': [3.824, 3.966, 5.090, 5.194]}
        self.neighborCutoffDistTol = {'V:V': [0.002, 0.002, 0.002, 0.002]}
        ...
        self.lambdaValues = {'V:V': [1.4768, 1.4964, 1.4652, 1.4932]} # reorganization energy in eV
        self.VAB = {'V:V': [0.000, 0.000, 0.000, 0.000]} # electronic coupling matrix element in eV
